//! Declarative native tensor operations, shared by core validation, shell
//! registration, help and documentation. Deliberately has no tch dependency.
//!
...
pub static OPS: &[OpSpec] = &[
    ...
    OpSpec {
        ...
        category: "pointwise",
        tensors: Arity::Exactly(1),
        params: &[pos("exponent", ParamKind::TensorOrScalar)],
        results: ResultKind::Tensors(1),
        broadcasts: false,
    ...
    OpSpec {
        ...
        tensors: Arity::Exactly(1),
        params: &[
            flag("min", ParamKind::TensorOrScalar),
            flag("max", ParamKind::TensorOrScalar),
        ],
        results: ResultKind::Tensors(1),
        broadcasts: false,
    ...
    OpSpec {
        ...
        broadcasts: true,
        summary: "true if all elements are close (returns a bool)",
    },
    OpSpec {
        name: "sort",
        category: "comparison",
    ...
    OpSpec {
        ...
        results: ResultKind::VariableTensors,
        broadcasts: false,
    ...
    OpSpec {
        ...
        results: ResultKind::Value,
        broadcasts: false,
        summary: "whole-tensor equality (returns a bool)",
    },
    OpSpec {
        name: "topk",
        category: "comparison",
    ...
    OpSpec {
        ...
        results: ResultKind::Tensors(1),
        broadcasts: false,
        summary: "range [--start, end) by --step",
    },
    OpSpec {
        name: "linspace",
        category: "creation",
    ...
    OpSpec {
        ...
        category: "pointwise",
        tensors: Arity::Exactly(2),
        params: &[pos("weight", ParamKind::TensorOrScalar)],
        results: ResultKind::Tensors(1),
        broadcasts: true,
...
mod tests {
    ...
    #[test]
    fn table_preserves_the_complete_migration_baseline() {
        assert_eq!(OPS.len(), 185);
    }
}
