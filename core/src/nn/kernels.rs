//! Private leaf kernels and optimizer arithmetic. Native shared wrappers own
//! composition and acquire the execution gate before calling this module.
...
impl NnModule {
    ...
    pub fn describe(&self) -> Vec<String> {
        ...
        if matches!(self, NnModule::Dropout { .. } | NnModule::BatchNorm { .. }) {
